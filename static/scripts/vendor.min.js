...
if (function(e, t) {
        ...
        function m(e, t) {
            for (var n, i, r = [], o = 0, s = e.length; o < s; o++) i = e[o], i.style && (n = i.style.display, t ? ("none" === n && (r[o] = je.get(i, "display") || null, r[o] || (i.style.display = "")), "" === i.style.display && Be(i) && (r[o] = g(i))) : "none" !== n && (r[o] = "none", je.set(i, "display", n)));
        ...
        function b(e, t, n, i, r) {
            for (var o, s, a, l, u, c, f = t.createDocumentFragment(), d = [], h = 0, p = e.length; h < p; h++)
                ...
                for (s = s || f.appendChild(t.createElement("div")), a = (Qe.exec(o) || ["", ""])[1].toLowerCase(), l = Ke[a] || Ke._default, s.innerHTML = l[1] + pe.htmlPrefilter(o) + l[2], c = l[0]; c--;) s = s.lastChild;
                pe.merge(d, s.childNodes), s = f.firstChild, s.textContent = ""
            } else d.push(t.createTextNode(o));
            for (f.textContent = "", h = 0; o = d[h++];)
                if (i && pe.inArray(o, i) > -1) r && r.push(o);
                else if (u = pe.contains(o.ownerDocument, o), s = v(f.appendChild(o), "script"), u && y(s), n)
        ...
        function A(e, t) {
            var n, i, r, o, s, a, l, u;
            if (1 === t.nodeType) {
                if (je.hasData(e) && (o = je.access(e), s = je.set(t, o), u = o.events)) {
        ...
        function k(e, t, i, r) {
            ...
            if (d && (o = b(t, e[0].ownerDocument, !1, e, r), s = o.firstChild, 1 === o.childNodes.length && (o = s), s || r)) {
                for (a = pe.map(v(o, "script"), x), l = a.length; f < d; f++) u = o, f !== h && (u = pe.clone(u, !0, !0), l && pe.merge(a, v(u, "script"))), i.call(e[f], u, f);
                if (l)
                    for (c = a[a.length - 1].ownerDocument, pe.map(a, S), f = 0; f < l; f++) u = a[f], $e.test(u.type || "") && !je.access(u, "globalEval") && pe.contains(c, u) && (u.src ? pe._evalUrl && pe._evalUrl(u.src) : n(u.textContent.replace(rt, ""), c))
            }
            return e
        }

        function O(e, t, n) {
            for (var i, r = t ? pe.filter(t, e) : e, o = 0; null != (i = r[o]); o++) n || 1 !== i.nodeType || pe.cleanData(v(i)), i.parentNode && (n && pe.contains(i.ownerDocument, i) && y(v(i, "script")), i.parentNode.removeChild(i));
            return e
        }
        ...
        function j(e, t, n, i, r) {
            var o, s = 0;
            for (o = n === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0; o < 4; o += 2) "margin" === n && (s += pe.css(e, n + qe[o], !0, r)), i ? ("content" === n && (s -= pe.css(e, "padding" + qe[o], !0, r)), "margin" !== n && (s -= pe.css(e, "border" + qe[o] + "Width", !0, r))) : (s += pe.css(e, "padding" + qe[o], !0, r), "padding" !== n && (s += pe.css(e, "border" + qe[o] + "Width", !0, r)));
            return s
        }
        ...
        function H(e, t, n) {
            ...
            if (e.getClientRects().length && (i = e.getBoundingClientRect()[t]), i <= 0 || null == i) {
                if (i = D(e, t, o), (i < 0 || null == i) && (i = e.style[t]), st.test(i)) return i;
        ...
        function B(e, t, n) {
            ...
            for (i in t)
                ...
                f && 1 === e.nodeType && (n.overflow = [p.overflow, p.overflowX, p.overflowY], u = v && v.display, null == u && (u = je.get(e, "display")), c = pe.css(e, "display"), "none" === c && (u ? c = u : (m([e], !0), u = e.style.display || u, c = pe.css(e, "display"), m([e]))), ("inline" === c || "inline-block" === c && null != u) && "none" === pe.css(e, "float") && (l || (d.done(function() {
                    p.display = u
                }), null == u && (c = p.display, u = "none" === c ? "" : c)), p.display = "inline-block")), n.overflow && (p.overflow = "hidden", d.always(function() {
                    p.overflow = n.overflow[0], p.overflowX = n.overflow[1], p.overflowY = n.overflow[2]
                })), l = !1;
                for (i in h) l || (v ? "hidden" in v && (g = v.hidden) : v = je.access(e, "fxshow", {
                    display: u
                }), o && (v.hidden = !g), g && m([e], !0), d.done(function() {
                    g || m([e]), je.remove(e, "fxshow");
                    for (i in h) pe.style(e, i, h[i])
                })), l = q(g ? v[i] : 0, i, d), i in v || (v[i] = l.start, g && (l.end = l.start, l.start = 0))
            }
        }
        ...
        function U(e, t, n) {
            var i, r, o = 0,
                ...
                l = function() {
                    if (r) return !1;
                    for (var t = ht || F(), n = Math.max(0, u.startTime + u.duration - t), i = n / u.duration || 0, o = 1 - i, s = 0, l = u.tweens.length; s < l; s++) u.tweens[s].run(o);
        ...
        function $(e, t, n, i) {
            ...
            if (pe.isArray(t)) pe.each(t, function(t, r) {
                n || St.test(e) ? i(e, r) : $(e + "[" + ("object" == typeof r && null != r ? t : "") + "]", r, n, i)
            });
        ...
        var be = function(e) {
            function t(e, t, n, i) {
                ...
                if (!i && ((t ? t.ownerDocument || t : q) !== L && N(t), t = t || L, j)) {
                    if (11 !== p && (l = ve.exec(e)))
                        if (r = l[1]) {
                            if (9 === p) {
                            ...
                            if ((r = l[3]) && E.getElementsByClassName && t.getElementsByClassName) return Z.apply(n, t.getElementsByClassName(r)), n
                        } if (E.qsa && !Q[e + " "] && (!H || !H.test(e))) {
                        if (1 !== p) d = t, c = e;
                        else if ("object" !== t.nodeName.toLowerCase()) {
                            for ((a = t.getAttribute("id")) ? a = a.replace(_e, Ee) : t.setAttribute("id", a = W), u = S(e), o = u.length; o--;) u[o] = "#" + a + " " + h(u[o]);
                ...
                var r = n.length > 0,
                    ...
                    s = function(i, s, a, l, u) {
                        var c, f, d, h = 0,
                            ...
                            _ = b.length;
                        for (u && (k = s === L || s || u); p !== _ && null != (c = b[p]); p++) {
                            if (o && c) {
                                for (f = 0, s || c.ownerDocument === L || (N(c), a = !j); d = e[f++];)
                                    if (d(c, s || L, a)) {
                                        l.push(c);
                                        break
                                    } u && (B = w)
            ...
            var _, E, T, C, x, S, A, I, k, O, D, N, L, P, j, H, M, R, F, W = "sizzle" + 1 * new Date,
                q = e.document,
                B = 0,
                z = 0,
                U = n(),
            ...
            E = t.support = {}, x = t.isXML = function(e) {
                var t = e && (e.ownerDocument || e).documentElement;
                return !!t && "HTML" !== t.nodeName
            }, N = t.setDocument = function(e) {
                var t, n, i = e ? e.ownerDocument || e : q;
                return i !== L && 9 === i.nodeType && i.documentElement ? (L = i, P = L.documentElement, j = !x(L), q !== L && (n = L.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", Te, !1) : n.attachEvent && n.attachEvent("onunload", Te)), E.attributes = r(function(e) {
                    return e.className = "i", !e.getAttribute("className")
                }), E.getElementsByTagName = r(function(e) {
                    return e.appendChild(L.createComment("")), !e.getElementsByTagName("*").length
                }), E.getElementsByClassName = me.test(L.getElementsByClassName), E.getById = r(function(e) {
                    return P.appendChild(e).id = W, !L.getElementsByName || !L.getElementsByName(W).length
                }), E.getById ? (T.filter.ID = function(e) {
                ...
                }, M = [], H = [], (E.qsa = me.test(L.querySelectorAll)) && (r(function(e) {
                ...
                })), (E.matchesSelector = me.test(R = P.matches || P.webkitMatchesSelector || P.mozMatchesSelector || P.oMatchesSelector || P.msMatchesSelector)) && r(function(e) {
                    E.disconnectedMatch = R.call(e, "*"), R.call(e, "[s!='']:x"), M.push("!=", oe)
                }), H = H.length && new RegExp(H.join("|")), M = M.length && new RegExp(M.join("|")), t = me.test(P.compareDocumentPosition), F = t || me.test(P.contains) ? function(e, t) {
                    ...
                    return n ? n : (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !E.sortDetached && t.compareDocumentPosition(e) === n ? e === L || e.ownerDocument === q && F(q, e) ? -1 : t === L || t.ownerDocument === q && F(q, t) ? 1 : O ? ee(O, e) - ee(O, t) : 0 : 4 & n ? -1 : 1)
                } : function(e, t) {
                    if (e === t) return D = !0, 0;
                    var n, i = 0,
                        r = e.parentNode,
                ...
                if ((e.ownerDocument || e) !== L && N(e), n = n.replace(ce, "='$1']"), E.matchesSelector && j && !Q[n + " "] && (!M || !M.test(n)) && (!H || !H.test(n))) try {
                    var i = R.call(e, n);
                    if (i || E.disconnectedMatch || e.document && 11 !== e.document.nodeType) return i
                } catch (r) {}
                return t(n, L, null, [e]).length > 0
            }, t.contains = function(e, t) {
                return (e.ownerDocument || e) !== L && N(e), F(e, t)
            }, t.attr = function(e, t) {
                (e.ownerDocument || e) !== L && N(e);
                var n = T.attrHandle[t.toLowerCase()],
                    i = n && K.call(T.attrHandle, t.toLowerCase()) ? n(e, t, !j) : void 0;
                return void 0 !== i ? i : E.attributes || !j ? e.getAttribute(t) : (i = e.getAttributeNode(t)) && i.specified ? i.value : null
            }, t.escape = function(e) {
                ...
                var t, n = [],
                    i = 0,
                    r = 0;
                if (D = !E.detectDuplicates, O = !E.sortStable && e.slice(0), e.sort($), D) {
                        ...
                        return 1 === i && 0 === r ? function(e) {
                            ...
                            if (m) {
                                ...
                                if (p = [s ? m.firstChild : m.lastChild], s && y) {
                                    for (d = m, f = d[W] || (d[W] = {}), c = f[d.uniqueID] || (f[d.uniqueID] = {}), u = c[e] || [], h = u[0] === B && u[1], b = h && u[2], d = h && m.childNodes[h]; d = ++h && d && d[g] || (b = h = 0) || p.pop();)
                                        if (1 === d.nodeType && ++b && d === t) {
                                            c[e] = [B, h, b];
                                            break
                                        }
                                } else if (y && (d = t, f = d[W] || (d[W] = {}), c = f[d.uniqueID] || (f[d.uniqueID] = {}), u = c[e] || [], h = u[0] === B && u[1], b = h), b === !1)
                                    for (;
                                        (d = ++h && d && d[g] || (b = h = 0) || p.pop()) && ((a ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++b || (y && (f = d[W] || (d[W] = {}), c = f[d.uniqueID] || (f[d.uniqueID] = {}), c[e] = [B, b]), d !== t)););
            ...
            return d.prototype = T.filters = T.pseudos, T.setFilters = new d, S = t.tokenize = function(e, n) {
                ...
                var n, i = [],
                    ...
                    o = Q[e + " "];
                if (!o) {
                    for (t || (t = S(e)), n = t.length; n--;) o = b(t[n]), o[W] ? i.push(o) : r.push(o);
                ...
                if (n = n || [], 1 === c.length) {
                    if (o = c[0] = c[0].slice(0), o.length > 2 && "ID" === (s = o[0]).type && 9 === t.nodeType && j && T.relative[o[1].type]) {
                    ...
                    for (r = he.needsContext.test(e) ? 0 : o.length; r-- && (s = o[r], !T.relative[a = s.type]);)
                        if ((l = T.find[a]) && (i = l(s.matches[0].replace(be, we), ye.test(o[0].type) && f(t.parentNode) || t))) {
                            if (o.splice(r, 1), e = i.length && h(o), !e) return Z.apply(n, i), n;
                            break
                        }
                }
                return (u || A(e, c))(i, t, !j, n, !t || ye.test(e) && f(t.parentNode) || t), n
            }, E.sortStable = W.split("").sort($).join("") === W, E.detectDuplicates = !!D, N(), E.sortDetached = r(function(e) {
        ...
        pe.filter = function(e, t, n) {
            ...
            is: function(e) {
                return !!r(this, "string" == typeof e && Ee.test(e) ? pe(e) : e || [], !1).length
            }
        });
        var xe, Se = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/,
            Ae = pe.fn.init = function(e, t, n) {
                var i, r;
                if (!e) return this;
        ...
        pe.fn.extend({
            ...
            pe.fn[e] = function(n, i) {
                ...
                return "Until" !== e.slice(-5) && (i = n), i && "string" == typeof i && (r = pe.filter(i, r)), this.length > 1 && (ke[e] || pe.uniqueSort(r), Ie.test(e) && r.reverse()), this.pushStack(r)
            }
        });
        var Oe = /[^\x20\t\r\n\f]+/g;
        ...
        pe.extend({
            hasData: function(e) {
                return He.hasData(e) || je.hasData(e)
            },
            data: function(e, t, n) {
            ...
            data: function(e, t) {
                ...
                if (void 0 === e) {
                    if (this.length && (r = He.get(o), 1 === o.nodeType && !je.get(o, "hasDataAttrs"))) {
                        for (n = s.length; n--;) s[n] && (i = s[n].name, 0 === i.indexOf("data-") && (i = pe.camelCase(i.slice(5)), h(o, i, r[i])));
            ...
            queue: function(e, t, n) {
                var i;
                if (e) return t = (t || "fx") + "queue", i = je.get(e, t), n && (!i || pe.isArray(n) ? i = je.access(e, t, pe.makeArray(n)) : i.push(n)), i || []
            },
            ...
            promise: function(e, t) {
                ...
                for ("string" != typeof e && (t = e, e = void 0), e = e || "fx"; s--;) n = je.get(o[s], e + "queueHooks"), n && n.empty && (i++, n.empty.add(a));
        ...
        pe.event = {
            ...
            add: function(e, t, n, i, r) {
                var o, s, a, l, u, c, f, d, h, p, g, m = je.get(e);
                if (m)
                    for (n.handler && (o = n, n = o.handler, r = o.selector), r && pe.find.matchesSelector(Ye, r), n.guid || (n.guid = pe.guid++), (l = m.events) || (l = m.events = {}), (s = m.handle) || (s = m.handle = function(t) {
                            return "undefined" != typeof pe && pe.event.triggered !== t.type ? pe.event.dispatch.apply(e, arguments) : void 0
                        }), t = (t || "").match(Oe) || [""], u = t.length; u--;) a = Je.exec(t[u]) || [], h = g = a[1], p = (a[2] || "").split(".").sort(), h && (f = pe.event.special[h] || {}, h = (r ? f.delegateType : f.bindType) || h, f = pe.event.special[h] || {}, c = pe.extend({
                        type: h,
                        origType: g,
                        data: i,
                        handler: n,
                        ...
                        namespace: p.join(".")
                    }, o), (d = l[h]) || (d = l[h] = [], d.delegateCount = 0, f.setup && f.setup.call(e, i, p, s) !== !1 || e.addEventListener && e.addEventListener(h, s)), f.add && (f.add.call(e, c), c.handler.guid || (c.handler.guid = n.guid)), r ? d.splice(d.delegateCount++, 0, c) : d.push(c), pe.event.global[h] = !0)
            },
            remove: function(e, t, n, i, r) {
                var o, s, a, l, u, c, f, d, h, p, g, m = je.hasData(e) && je.get(e);
                if (m && (l = m.events)) {
                    for (t = (t || "").match(Oe) || [""], u = t.length; u--;)
                        if (a = Je.exec(t[u]) || [], h = g = a[1], p = (a[2] || "").split(".").sort(), h) {
                            for (f = pe.event.special[h] || {}, h = (i ? f.delegateType : f.bindType) || h, d = l[h] || [], a = a[2] && new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = o = d.length; o--;) c = d[o], !r && g !== c.origType || n && n.guid !== c.guid || a && !a.test(c.namespace) || i && i !== c.selector && ("**" !== i || !c.selector) || (d.splice(o, 1), c.selector && d.delegateCount--, f.remove && f.remove.call(e, c));
                            s && !d.length && (f.teardown && f.teardown.call(e, p, m.handle) !== !1 || pe.removeEvent(e, h, m.handle), delete l[h])
                        } else
                            for (h in l) pe.event.remove(e, h + t[u], n, i, !0);
            ...
            return this instanceof pe.Event ? (e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && e.returnValue === !1 ? w : _, this.target = e.target && 3 === e.target.nodeType ? e.target.parentNode : e.target, this.currentTarget = e.currentTarget, this.relatedTarget = e.relatedTarget) : this.type = e, t && pe.extend(this, t), this.timeStamp = e && e.timeStamp || pe.now(), void(this[pe.expando] = !0)) : new pe.Event(e, t)
        }, pe.Event.prototype = {
        ...
        pe.extend({
            ...
            clone: function(e, t, n) {
                ...
                if (!(de.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || pe.isXMLDoc(e)))
                    for (s = v(a), o = v(e), i = 0, r = o.length; i < r; i++) I(o[i], s[i]);
                if (t)
                    if (n)
            ...
            html: function(e) {
                return Le(this, function(e) {
                    ...
                    if ("string" == typeof e && !tt.test(e) && !Ke[(Qe.exec(e) || ["", ""])[1].toLowerCase()]) {
        ...
        pe.extend({
            ...
            style: function(e, t, n, i) {
                if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                    var r, o, s, a = pe.camelCase(t),
                        l = e.style;
                    return t = pe.cssProps[a] || (pe.cssProps[a] = L(a) || a), s = pe.cssHooks[t] || pe.cssHooks[a], void 0 === n ? s && "get" in s && void 0 !== (r = s.get(e, !1, i)) ? r : l[t] : (o = typeof n, "string" === o && (r = We.exec(n)) && r[1] && (n = p(e, t, r), o = "number"), null != n && n === n && ("number" === o && (n += r && r[3] || (pe.cssNumber[a] ? "" : "px")), de.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (l[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, i)) || (l[t] = n)), void 0)
                }
            },
            css: function(e, t, n, i) {
                var r, o, s, a = pe.camelCase(t);
                return t = pe.cssProps[a] || (pe.cssProps[a] = L(a) || a), s = pe.cssHooks[t] || pe.cssHooks[a], s && "get" in s && (r = s.get(e, !0, n)), void 0 === r && (r = D(e, t, i)), "normal" === r && t in ct && (r = ct[t]), "" === n || n ? (o = parseFloat(r), n === !0 || isFinite(o) ? o || 0 : r) : r
            }
        }), pe.each(["height", "width"], function(e, t) {
            pe.cssHooks[t] = {
                get: function(e, n, i) {
                    if (n) return !lt.test(pe.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? H(e, t, i) : ze(e, ut, function() {
                        return H(e, t, i)
                    })
                },
                set: function(e, n, i) {
                    var r, o = i && at(e),
                        s = i && j(e, t, i, "border-box" === pe.css(e, "boxSizing", !1, o), o);
                    return s && (r = We.exec(n)) && "px" !== (r[3] || "px") && (e.style[t] = n, n = pe.css(e, t)), P(e, n, s)
                }
            }
        }), pe.cssHooks.marginLeft = N(de.reliableMarginLeft, function(e, t) {
            if (t) return (parseFloat(D(e, "marginLeft")) || e.getBoundingClientRect().left - ze(e, {
                marginLeft: 0
            }, function() {
            ...
            }, ot.test(e) || (pe.cssHooks[e + t].set = P)
        }), pe.fn.extend({
            css: function(e, t) {
        ...
        pe.fn.extend({
            ...
            toggleClass: function(e, t) {
                ...
                return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : pe.isFunction(e) ? this.each(function(n) {
                    ...
                    else void 0 !== e && "boolean" !== n || (t = Q(this), t && je.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || e === !1 ? "" : je.get(this, "__className__") || ""))
                })
            },
            hasClass: function(e) {
                var t, n, i = 0;
        ...
        pe.fn.extend({
            val: function(e) {
                var t, n, i, r = this[0]; {
                    ...
                    if (r) return t = pe.valHooks[r.type] || pe.valHooks[r.nodeName.toLowerCase()], t && "get" in t && void 0 !== (n = t.get(r, "value")) ? n : (n = r.value, "string" == typeof n ? n.replace(_t, "") : null == n ? "" : n)
                }
            }
        }), pe.extend({
            valHooks: {
        ...
        pe.extend(pe.event, {
            trigger: function(t, n, i, r) {
                ...
                if (s = a = i = i || te, 3 !== i.nodeType && 8 !== i.nodeType && !Et.test(h + pe.event.triggered) && (h.indexOf(".") > -1 && (p = h.split("."), h = p.shift(), p.sort()), u = h.indexOf(":") < 0 && "on" + h, t = t[pe.expando] ? t : new pe.Event(h, "object" == typeof t && t), t.isTrigger = r ? 2 : 3, t.namespace = p.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : pe.makeArray(n, [t]), f = pe.event.special[h] || {}, r || !f.trigger || f.trigger.apply(i, n) !== !1)) {
                    ...
                    for (o = 0;
                        (s = d[o++]) && !t.isPropagationStopped();) t.type = o > 1 ? l : f.bindType || h, c = (je.get(s, "events") || {})[t.type] && je.get(s, "handle"), c && c.apply(s, n), c = u && s[u], c && c.apply && Pe(s) && (t.result = c.apply(s, n), t.result === !1 && t.preventDefault());
                    return t.type = h, r || t.isDefaultPrevented() || f._default && f._default.apply(d.pop(), n) !== !1 || !Pe(i) || u && pe.isFunction(i[h]) && !pe.isWindow(i) && (a = i[u], a && (i[u] = null), pe.event.triggered = h, i[h](), pe.event.triggered = void 0, a && (i[u] = a)), t.result
                }
            },
        ...
        pe.param = function(e, t) {
            ...
            serializeArray: function() {
                return this.map(function() {
                    ...
                    var e = this.type;
                    return this.name && !pe(this).is(":disabled") && kt.test(this.nodeName) && !It.test(e) && (this.checked || !Ve.test(e))
                }).map(function(e, t) {
                    var n = pe(this).val();
        ...
        Wt.href = Tt.href, pe.extend({
            ...
            ajax: function(t, n) {
                function i(t, n, i, a) {
                    var u, d, h, w, _, E = n;
                    c || (c = !0, l && e.clearTimeout(l), r = void 0, s = a || "", T.readyState = t > 0 ? 4 : 0, u = t >= 200 && t < 300 || 304 === t, i && (w = X(p, T, i)), w = Z(p, w, T, u), u ? (p.ifModified && (_ = T.getResponseHeader("Last-Modified"), _ && (pe.lastModified[o] = _), _ = T.getResponseHeader("etag"), _ && (pe.etag[o] = _)), 204 === t || "HEAD" === p.type ? E = "nocontent" : 304 === t ? E = "notmodified" : (E = w.state, d = w.data, h = w.error, u = !h)) : (h = E, !t && E || (E = "error", t < 0 && (t = 0))), T.status = t, T.statusText = (n || E) + "", u ? v.resolveWith(g, [d, E, T]) : v.rejectWith(g, [T, E, h]), T.statusCode(b), b = void 0, f && m.trigger(u ? "ajaxSuccess" : "ajaxError", [T, p, u ? d : h]), y.fireWith(g, [T, E]), f && (m.trigger("ajaxComplete", [T, p]), --pe.active || pe.event.trigger("ajaxStop")))
                }
                "object" == typeof t && (n = t, t = void 0), n = n || {};
                var r, o, s, a, l, u, c, f, d, h, p = pe.ajaxSetup({}, n),
                    g = p.context || p,
                ...
                if (v.promise(T), p.url = ((t || p.url || Tt.href) + "").replace(Ht, Tt.protocol + "//"), p.type = n.method || n.type || p.method || p.type, p.dataTypes = (p.dataType || "*").toLowerCase().match(Oe) || [""], null == p.crossDomain) {
                ...
                if (p.data && p.processData && "string" != typeof p.data && (p.data = pe.param(p.data, p.traditional)), G(Mt, p, n, T), c) return T;
                f = pe.event && p.global, f && 0 === pe.active++ && pe.event.trigger("ajaxStart"), p.type = p.type.toUpperCase(), p.hasContent = !jt.test(p.type), o = p.url.replace(Dt, ""), p.hasContent ? p.data && p.processData && 0 === (p.contentType || "").indexOf("application/x-www-form-urlencoded") && (p.data = p.data.replace(Ot, "+")) : (h = p.url.slice(o.length), p.data && (o += (xt.test(o) ? "&" : "?") + p.data, delete p.data), p.cache === !1 && (o = o.replace(Nt, "$1"), h = (xt.test(o) ? "&" : "?") + "_=" + Ct++ + h), p.url = o + h), p.ifModified && (pe.lastModified[o] && T.setRequestHeader("If-Modified-Since", pe.lastModified[o]), pe.etag[o] && T.setRequestHeader("If-None-Match", pe.etag[o])), (p.data && p.hasContent && p.contentType !== !1 || n.contentType) && T.setRequestHeader("Content-Type", p.contentType), T.setRequestHeader("Accept", p.dataTypes[0] && p.accepts[p.dataTypes[0]] ? p.accepts[p.dataTypes[0]] + ("*" !== p.dataTypes[0] ? ", " + Ft + "; q=0.01" : "") : p.accepts["*"]);
                for (d in p.headers) T.setRequestHeader(d, p.headers[d]);
                if (p.beforeSend && (p.beforeSend.call(g, T, p) === !1 || c)) return T.abort();
                if (E = "abort", y.add(p.complete), T.done(p.success), T.fail(p.error), r = G(Rt, p, n, T)) {
        ...
        pe.ajaxSetup({
            ...
            var i, r, o;
            return t || (de.createHTMLDocument ? (t = te.implementation.createHTMLDocument(""), i = t.createElement("base"), i.href = te.location.href, t.head.appendChild(i)) : t = te), r = Te.exec(e), o = !n && [], r ? [t.createElement(r[1])] : (r = b([e], t, o), o && o.length && pe(o).remove(), pe.merge([], r.childNodes))
        }, pe.fn.load = function(e, t, n) {
            var i, r, o, s = this,
                a = e.indexOf(" ");
            return a > -1 && (i = V(e.slice(a)), e = e.slice(0, a)), pe.isFunction(t) ? (n = t, t = void 0) : t && "object" == typeof t && (r = "POST"), s.length > 0 && pe.ajax({
                url: e,
                type: r || "GET",
                dataType: "html",
                data: t
            ...
            setOffset: function(e, t, n) {
                var i, r, o, s, a, l, u, c = pe.css(e, "position"),
                    f = pe(e),
                    d = {};
                "static" === c && (e.style.position = "relative"), a = f.offset(), o = pe.css(e, "top"), l = pe.css(e, "left"), u = ("absolute" === c || "fixed" === c) && (o + l).indexOf("auto") > -1, u ? (i = f.position(), s = i.top, r = i.left) : (s = parseFloat(o) || 0, r = parseFloat(l) || 0), pe.isFunction(t) && (t = t.call(e, n, pe.extend({}, a))), null != t.top && (d.top = t.top - a.top + s), null != t.left && (d.left = t.left - a.left + r), "using" in t ? t.using.call(e, d) : f.css(d)
            }
        }, pe.fn.extend({
            offset: function(e) {
        ...
        return pe.noConflict = function(t) {
            return e.$ === pe && (e.$ = Qt), t && e.jQuery === pe && (e.jQuery = Vt), pe
        }, t || (e.jQuery = e.$ = pe), pe
    }), function(e, t) {
        ...
        var x = null,
            ...
            I = function() {
                var e = x;
                e || (e = document.createElement("div"), e.setAttribute("data-tether-id", S()), c(e.style, {
                    top: 0,
                    left: 0,
                    position: "absolute"
        ...
        ! function() {
            var e = null,
                ...
                n = null,
                i = function r() {
                    return "undefined" != typeof t && t > 16 ? (t = Math.min(t - 16, 250), void(n = setTimeout(r, 250))) : void("undefined" != typeof e && b() - e < 10 || (null != n && (clearTimeout(n), n = null), e = b(), F(), t = b() - e))
                };
        ...
        var W = {
            ...
            z = function(e, t) {
                var n = e.left,
                    i = e.top;
                return "auto" === n && (n = W[t.left]), "auto" === i && (i = q[t.top]), {
                    left: n,
                    top: i
                }
            },
            ...
            $ = function(e) {
                function t(e) {
                    var n = this;
                    i(this, t), j(Object.getPrototypeOf(t.prototype), "constructor", this).call(this), this.position = this.position.bind(this), R.push(this), this.history = [], this.setOptions(e, !1), C.modules.forEach(function(e) {
                ...
                return v(t, e), T(t, [{
                    ...
                    value: function() {
                        ...
                        if ("scroll-handle" === this.targetModifier) {
                            ...
                            var s = e.height - parseFloat(i.borderTopWidth) - parseFloat(i.borderBottomWidth) - o,
                                ...
                                l = 0;
                            s < 408 && this.target === document.body && (l = -11e-5 * Math.pow(s, 2) - .00727 * s + 22.58), this.target !== document.body && (t.height = Math.max(t.height, 24));
                    ...
                    value: function(e, t) {
                        ...
                        i.forEach(function(e) {
                            ...
                            "undefined" != typeof n._addAttachClasses && (m(n.element, n._addAttachClasses, o), n.options.addTargetClasses !== !1 && m(n.target, n._addAttachClasses, o), delete n._addAttachClasses)
                        })
                    }
                }, {
                    key: "position",
                    value: function() {
                        ...
                        if (this.enabled) {
                            ...
                            for (var m = c.left + h.left - d.left, v = c.top + h.top - d.top, y = 0; y < C.modules.length; ++y) {
                                ...
                                if (E === !1) return !1;
                                "undefined" != typeof E && "object" == typeof E && (v = E.top, m = E.left)
                            }
                            var T = {
                                    page: {
                                        top: v,
                                ...
                                S = x.defaultView,
                                A = void 0;
                            return S.innerHeight > x.documentElement.clientHeight && (A = this.cache("scrollbar-size", u), T.viewport.bottom -= A.height), S.innerWidth > x.documentElement.clientWidth && (A = this.cache("scrollbar-size", u), T.viewport.right -= A.width), ["", "static"].indexOf(x.body.style.position) !== -1 && ["", "static"].indexOf(x.body.parentElement.style.position) !== -1 || (T.page.bottom = x.body.scrollHeight - v - o, T.page.right = x.body.scrollWidth - m - r), "undefined" != typeof this.options.optimizations && this.options.optimizations.moveElement !== !1 && "undefined" == typeof this.targetModifier && ! function() {
                                ...
                                if (["Top", "Left", "Bottom", "Right"].forEach(function(e) {
                                    ...
                                    }), n.right = x.body.scrollWidth - n.left - r.width + o.right, n.bottom = x.body.scrollHeight - n.top - r.height + o.bottom, T.page.top >= n.top + o.top && T.page.bottom >= n.bottom && T.page.left >= n.left + o.left && T.page.right >= n.right) {
                                    var s = t.scrollTop,
                                        u = t.scrollLeft;
                                    T.offset = {
                                        top: T.page.top - n.top + s - o.top,
                            ...
                            var u = {
                                ...
                                f = function(e, n) {
                                    ...
                                    if (r !== !1) {
                                        ...
                                        u[M] = "translateX(" + s + "px) translateY(" + o + "px)", "msTransform" !== M && (u[M] += " translateZ(0)")
        ...
        C.modules.push({
            position: function(e) {
                ...
                return this.options.constraints.forEach(function(e) {
                    ...
                    var b = E(t, o);
                    "target" !== f && "both" !== f || (n < b[1] && "top" === v.top && (n += d, v.top = "bottom"), n + s > b[3] && "bottom" === v.top && (n -= d, v.top = "top")), "together" === f && ("top" === v.top && ("bottom" === y.top && n < b[1] ? (n += d, v.top = "bottom", n += s, y.top = "top") : "top" === y.top && n + s > b[3] && n - (s - d) >= b[1] && (n -= s - d, v.top = "bottom", y.top = "bottom")), "bottom" === v.top && ("top" === y.top && n + s > b[3] ? (n -= d, v.top = "top", n -= s, y.top = "bottom") : "bottom" === y.top && n < b[1] && n + (2 * s - d) <= b[3] && (n += s - d, v.top = "top", y.top = "top")), "middle" === v.top && (n + s > b[3] && "top" === y.top ? (n -= s, y.top = "bottom") : n < b[1] && "bottom" === y.top && (n += s, y.top = "top"))), "target" !== c && "both" !== c || (i < b[0] && "left" === v.left && (i += h, v.left = "right"), i + l > b[2] && "right" === v.left && (i -= h, v.left = "left")), "together" === c && (i < b[0] && "left" === v.left ? "right" === y.left ? (i += h, v.left = "right", i += l, y.left = "left") : "left" === y.left && (i += h, v.left = "right", i -= l, y.left = "right") : i + l > b[2] && "right" === v.left ? "left" === y.left ? (i -= h, v.left = "left", i -= l, y.left = "right") : "right" === y.left && (i -= h, v.left = "left", i += l, y.left = "left") : "center" === v.left && (i + l > b[2] && "left" === y.left ? (i -= l, y.left = "right") : i < b[0] && "right" === y.left && (i += l, y.left = "left"))), "element" !== f && "both" !== f || (n < b[1] && "bottom" === y.top && (n += s, y.top = "top"), n + s > b[3] && "top" === y.top && (n -= s, y.top = "bottom")), "element" !== c && "both" !== c || (i < b[0] && ("right" === y.left ? (i += l, y.left = "left") : "center" === y.left && (i += l / 2, y.left = "left")), i + l > b[2] && ("left" === y.left ? (i -= l, y.left = "right") : "center" === y.left && (i -= l / 2, y.left = "right"))), "string" == typeof u ? u = u.split(",").map(function(e) {
                        return e.trim()
                    }) : u === !0 && (u = ["top", "left", "right", "bottom"]), u = u || [];
                    var w = [],
                        _ = [];
                    n < b[1] && (u.indexOf("top") >= 0 ? (n = b[1], w.push("top")) : _.push("top")), n + s > b[3] && (u.indexOf("bottom") >= 0 ? (n = b[3] - s, w.push("bottom")) : _.push("bottom")), i < b[0] && (u.indexOf("left") >= 0 ? (i = b[0], w.push("left")) : _.push("left")), i + l > b[2] && (u.indexOf("right") >= 0 ? (i = b[2] - l, w.push("right")) : _.push("right")), w.length && ! function() {
                        var e = void 0;
                        ...
                        var e = void 0;
                        e = "undefined" != typeof t.options.outOfBoundsClass ? t.options.outOfBoundsClass : t.getClass("out-of-bounds"), g.push(e), _.forEach(function(t) {
                            g.push(e + "-" + t)
                        })
        ...
        C.modules.push({
            position: function(e) {
                ...
                return d.push(this.getClass("abutted")), p.forEach(function(e) {
                    ...
                    t.options.addTargetClasses !== !1 && m(t.target, h, d), m(t.element, h, d)
                }), !0
            }
        });
        var P = function() {
  ...
  function() {
        var e, t, n, i, r, o, s, a, l, u, c, f, d, h, p, g, m, v, y, b, w, _, E, T, C, x, S, A, I, k, O, D, N, L, P, j, H, M, R, F, W, q, B, z, U, V, Q, $, K, G = [].slice,
            Y = {}.hasOwnProperty,
            X = function(e, t) {
                function n() {
                    this.constructor = e
        ...
        for (w = {
                ...
                return t = I(), (n = function() {
                    var i;
                    return i = I() - t, i >= 33 ? (t = I(), e(i, function() {
                        return O(n)
                    })) : setTimeout(n, 33 - i)
                })()
            }, D = function() {
                ...
                var e, t, n, i, r, o, s;
                for (t = arguments[0], i = 2 <= arguments.length ? G.call(arguments, 1) : [], o = 0, s = i.length; o < s; o++)
                    if (n = i[o])
            ...
            }(), u = window.Pace || {}, window.Pace = u, _(u, s.prototype), k = u.options = _({}, w, window.paceOptions, T()), Q = ["ajax", "document", "eventLag", "elements"], B = 0, U = Q.length; B < U; B++) H = Q[B], k[H] === !0 && (k[H] = w[H]);
        l = function(e) {
            function t() {
            ...
            return e.prototype.getElement = function() {
                var e;
                if (null == this.el) {
                    if (e = document.querySelector(k.target), !e) throw new l;
        ...
        }(), q = window.XMLHttpRequest, W = window.XDomainRequest, F = window.WebSocket, E = function(e, t) {
            var n, i, r;
            r = [];
            ...
            if (!S.length && k.ajax) {
                ...
                if (t = e.toUpperCase(), Z.call(k.ajax.trackMethods, t) >= 0) return !0
            }
            return !1
        }, c = function(e) {
            function t() {
                ...
                if (null != W) {
                    window.XDomainRequest = function() {
                        var t;
                        return t = new W, e(t), t
                    };
                    try {
                        E(window.XDomainRequest, W)
                    } catch (i) {}
                }
                if (null != F && k.ajax.trackWebSockets) {
                    window.WebSocket = function(e, t) {
                        var i;
                        return i = null != t ? new F(e, t) : new F(e), j("socket") && n.trigger("request", {
                            type: "socket",
                            url: e,
                            protocols: t,
                            request: i
            ...
            var t, n, i, r;
            for (r = k.ajax.ignoreURLs, n = 0, i = r.length; n < i; n++)
            ...
            var n, i, r, o, s;
            if (o = t.type, r = t.request, s = t.url, !P(s)) return u.running || k.restartOnRequestAfter === !1 && "force" !== j(o) ? void 0 : (i = arguments, n = k.restartOnRequestAfter || 0, "boolean" == typeof n && (n = 0), setTimeout(function() {
                var t, n, s, a, l, c;
                if (t = "socket" === o ? r.readyState < 2 : 0 < (a = r.readyState) && a < 4) {
                    for (u.restart(), l = u.sources, c = [], n = 0, s = l.length; n < s; n++) {
                        if (H = l[n], H instanceof e) {
                            H.watch.apply(H, i);
                            break
                        }
                        c.push(void 0)
            ...
            function e() {
                ...
                this.progress = 0, e = 0, r = [], i = 0, n = I(), t = setInterval(function() {
                    var s;
                    return s = I() - n - 50, n = I(), r.push(s), r.length > k.eventLag.sampleCount && r.shift(), e = m(r), ++i >= k.eventLag.minSamples && e < k.eventLag.lagThreshold ? (o.progress = 100, clearInterval(t)) : o.progress = 100 * (3 / (e + 3))
                }, 50)
            }
            return e
        }(), d = function() {
            function e(e) {
                this.source = e, this.last = this.sinceLastUpdate = 0, this.rate = k.initialRate, this.catchup = 0, this.progress = this.lastProgress = 0, null != this.source && (this.progress = D(this.source, "progress"))
            }
            return e.prototype.tick = function(e, t) {
                var n;
                return null == t && (t = D(this.source, "progress")), t >= 100 && (this.done = !0), t === this.last ? this.sinceLastUpdate += e : (this.sinceLastUpdate && (this.rate = (t - this.last) / this.sinceLastUpdate), this.catchup = (t - this.progress) / k.catchupTime, this.sinceLastUpdate = 0, this.last = t), t > this.progress && (this.progress += this.catchup * e), n = 1 - Math.pow(this.progress / 100, k.easeFactor), this.progress += n * this.rate * e, this.progress = Math.min(this.lastProgress + k.maxProgressPerFrame, this.progress), this.progress = Math.max(0, this.progress), this.progress = Math.min(100, this.progress), this.lastProgress = this.progress, this.progress
            }, e
        }(), M = null, L = null, v = null, R = null, g = null, y = null, u.running = !1, x = function() {
            if (k.restartOnPushState) return u.restart()
        }, null != window.history.pushState && (V = window.history.pushState, window.history.pushState = function() {
            return x(), V.apply(window.history, arguments)
            ...
            var e, n, i, r, o, s, a, l;
            for (u.sources = M = [], s = ["ajax", "elements", "document", "eventLag"], n = 0, r = s.length; n < r; n++) e = s[n], k[e] !== !1 && M.push(new f[e](k[e]));
            for (l = null != (a = k.extraSources) ? a : [], i = 0, o = l.length; i < o; i++) H = l[i], M.push(new H(k));
            ...
            var e;
            return u.running = !0, v.render(), e = I(), y = !1, g = N(function(t, n) {
                var i, r, o, s, a, l, c, f, h, p, g, m, b, w, _, E;
                for (f = 100 - v.progress, r = g = 0, o = !0, l = m = 0, w = M.length; m < w; l = ++m)
                    for (H = M[l], p = null != L[l] ? L[l] : L[l] = [], a = null != (E = H.elements) ? E : [H], c = b = 0, _ = a.length; b < _; c = ++b) s = a[c], h = null != p[c] ? p[c] : p[c] = new d(s), o &= h.done, h.done || (r++, g += h.tick(t));
                ...
                }, Math.max(k.ghostTime, Math.max(k.minTime - (I() - e), 0)))) : n()
            })
        }, u.start = function(e) {
            _(k, e), u.running = !0;
            try {
            ...
            return u
        }) : "object" == typeof exports ? module.exports = u : k.startOnPageLoad && u.start()
    }.call(this), ! function(e) {
        e.fn.parallaxBackground = function(t) {
            function n() {
                u = l.height(), o.each(function(n) {
                    var i = e(this),
                        r = i.find(t.image);
            ...
            function i() {
                s = l.scrollTop(), e.each(a, function(e, t) {
                    var n = s >= t.distanceToVisible,
                        i = s >= t.height + t.offset;
                    if (n && !i) {
                        var r = s - t.distanceToVisible;
                        r -= t.scrollSpace / 2;
                        var o = t.parallaxSpace / t.scrollSpace,
                            a = (r * o).toFixed(1);
                        a *= -1, t.$image.css("transform", "translateY(" + a + "px)")
                    }
                }), requestAnimationFrame(i)
            }
            if (t.image) {
                var r = e(t.image);
                if (r.css("will-change", "transform"), r.show(), !/iP(ad|hone|od).*OS 7.*/.test(navigator.userAgent) && window.requestAnimationFrame) {
                    var o = this;
                    if (o.length) {
                        var s, a = [],
                            l = e(window),
                            u = l.height();
                        n(), l.resize(n), requestAnimationFrame(i)
                    }
                }
            }
        }
        ...
        var t, n, i, r, o, s, a, l = {},
            ...
            f = function() {
                ...
                for (var r = function(n) {
                        for (var i in n) Object.prototype.hasOwnProperty.call(n, i) && (t && "[object Object]" === Object.prototype.toString.call(n[i]) ? e[i] = f(!0, e[i], n[i]) : e[i] = n[i])
                    }; n < i; n++) {
                    var o = arguments[n];
                    r(o)
                }
            ...
            m = function(e, t, n) {
                ...
                return i = Math.max(i - t - n, 0), Math.min(i, y() - v())
            },
            v = function() {
        ...
        l.animateScroll = function(n, i, s) {
            ...
            if (d || h) {
                var p = e.pageYOffset;
                u.selectorHeader && !r && (r = document.querySelector(u.selectorHeader)), o || (o = w(r));
                var v, E, T = d ? n : m(h, o, parseInt(u.offset, 10)),
                    C = T - p,
                    x = y(),
                    S = 0,
                    A = function(t, r, o) {
                        var s = e.pageYOffset;
                        (t == r || s == r || e.innerHeight + s >= x) && (clearInterval(o), _(n, r, d), u.callback(n, i))
                    },
                    I = function() {
                        S += 16, v = S / parseInt(u.speed, 10), v = v > 1 ? 1 : v, E = p + C * g(u.easing, v), e.scrollTo(0, Math.floor(E)), A(E, T, a)
                    },
                    k = function() {
                        clearInterval(a), a = setInterval(I, 16)
                    };
        ...
        var E = function(t) {
                var r;
                try {
                    r = p(decodeURIComponent(e.location.hash))
                } catch (t) {
                    r = p(e.location.hash)
                }
            ...
            T = function(e) {
                if (0 === e.button && !e.metaKey && !e.ctrlKey && (i = h(e.target, t.selector), i && "a" === i.tagName.toLowerCase() && i.hostname === o.location.hostname && i.pathname === o.location.pathname && /#/.test(i.href))) {
                    var r;
                    try {
                    ...
                    if ("#" === r) {
                        e.preventDefault(), n = document.body;
                        var s = n.id ? n.id : "smooth-scroll-top";
                        return n.setAttribute("data-scroll-id", s), n.id = "", void(o.location.hash.substring(1) === s ? E() : o.location.hash = s)
                    }
                    n = document.querySelector(r), n && (n.setAttribute("data-scroll-id", n.id), n.id = "", i.hash === o.location.hash && (e.preventDefault(), E()))
                }
            },
            C = function(e) {
        ...
        return l.destroy = function() {
            t && (document.removeEventListener("click", T, !1), e.removeEventListener("resize", C, !1), t = null, n = null, i = null, r = null, o = null, s = null, a = null)
        }, l.init = function(n) {
            u && (l.destroy(), t = f(c, n || {}), r = t.selectorHeader ? document.querySelector(t.selectorHeader) : null, o = w(r), document.addEventListener("click", T, !1), e.addEventListener("hashchange", E, !1), r && e.addEventListener("resize", C, !1))
        }, l
    }), function(e) {
        "use strict";
                ...
                if (i)
                    for (var o = 0, s = i.length; o < s; ++o) {
                        var a = i[o].match(/%(-|!)?([a-zA-Z]{1})(:[^;]+;)?/),
                            ...
                            f = a[3] || "",
                            d = null;
                        a = a[2], l.hasOwnProperty(a) && (d = l[a], d = Number(e[d])), null !== d && ("!" === c && (d = r(f, d)), "" === c && d < 10 && (d = "0" + d.toString()), t = t.replace(u, d.toString()))
                    }
                return t = t.replace(/%%/, "%")
            }
        }
        ...
        e.extend(u.prototype, {
            ...
            return this.each(function() {
                ...
                if (void 0 !== n) {
                    var i = o[n],
                        r = t[0];
                    u.prototype.hasOwnProperty(r) ? i[r].apply(i, t.slice(1)) : null === String(r).match(/^[$A-Z_][0-9A-Z_$]*$/i) ? (i.setFinalDate.call(i, r), i.start()) : e.error("Method %s does not exist on jQuery.countdown".replace(/\%s/gi, r))
                } else new u(this, t[0], t[1])
            })
        }
